...
export function LoginScreen() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-canvas px-6">
      ...
      <div className="relative w-full max-w-sm animate-scale-in rounded-2xl border border-white/10 bg-surface-raised/80 p-8 text-center shadow-2xl shadow-black/40 backdrop-blur">
        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-700 text-white shadow-glow">
        ...
        <button
          ...
          className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-medium text-gray-900 shadow-sm transition hover:bg-gray-100 active:scale-[0.99]"
        >
