  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6">
      <div className="w-full max-w-sm rounded-xl border border-gray-800 bg-gray-900 p-8 text-center shadow-xl">
        <h1 className="text-xl font-bold text-gray-100">Livestream Archiver</h1>
        ...
        <button
          ...
          className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-md bg-white px-4 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100"
        >
