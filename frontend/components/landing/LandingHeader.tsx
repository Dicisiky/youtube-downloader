...
/** Fixed top bar for the scroll story -- stays on screen at every scroll position, above the 3D backdrop. */
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-5">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-md bg-white px-3.5 py-1.5 text-xs font-medium text-gray-900 shadow-sm transition hover:bg-gray-100"
          >
