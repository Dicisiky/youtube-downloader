...
/** The actual sign-in CTA the scroll story builds up to -- same action as LoginScreen's button. */
export function GoogleSignInButton() {
  return (
    <div className="flex flex-col items-center">
      <button
        onClick={() => api.loginWithGoogle()}
        className="inline-flex items-center justify-center gap-2 rounded-md bg-white px-5 py-2.5 text-sm font-medium text-gray-900 shadow-sm transition hover:bg-gray-100"
      >
